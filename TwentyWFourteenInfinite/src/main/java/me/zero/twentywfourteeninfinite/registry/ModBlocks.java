...
import me.zero.twentywfourteeninfinite.mixin.InvokerBlocks;
...
import me.zero.twentywfourteeninfinite.registry.block.ZoneBlock;
...
public class ModBlocks {
    ...
    public static final Block ZONE = new ZoneBlock(BlockBehaviour.Properties.of(Material.BARRIER).strength(-1.0F, 3600000.8F).noLootTable().noOcclusion().isValidSpawn(InvokerBlocks::invokeNever).isViewBlocking(InvokerBlocks::invokeAlways));
    ...
    public static final Block CURSOR = new Block(BlockBehaviour.Properties.of(Material.STONE, DyeColor.GREEN).strength(1.8F));

    public static void initBlocks() {
        BlockRegistry.registerBlock(new ResourceLocation(TwentyWFourteenInfiniteMod.MOD_ID, "neither_portal"), NEITHER_PORTAL);
        BlockRegistry.registerBlock(new ResourceLocation(TwentyWFourteenInfiniteMod.MOD_ID, "zone"), ZONE);
        ...
        BlockRegistry.registerBlock(new ResourceLocation(TwentyWFourteenInfiniteMod.MOD_ID, "cursor"), CURSOR);
    }
}
